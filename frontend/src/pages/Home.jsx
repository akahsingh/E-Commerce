      ...
      <section className="relative bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800 text-white -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight">
            India's Favourite
            <span className="block mt-2 text-indigo-200">Online Store</span>
          </h1>
          <p className="mt-6 text-lg sm:text-xl text-indigo-100 max-w-2xl mx-auto">
            Discover 1,00,000+ products across 19 categories. Free delivery, secure payments, and easy returns across India.
          </p>
      ...
      <section className="py-16 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 bg-white border-b">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            { icon: CreditCard, title: "Easy Payments", desc: "UPI, Cards, Net Banking" },
        ...
        <section className="py-16">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="mt-2 text-gray-500">Handpicked favourites from our customers</p>
            </div>
